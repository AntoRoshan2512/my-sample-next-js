...
export const routes = {
  ...
  appointment: {
    ...
    loyalty: "/rewards/loyalty-settings",
    ...
    editSegment: (id: string) => `/crm/segments/${id}/edit`,
  },

  feedback: {
    dashboard: "/feedback",
    action_engine: "/feedback/action-engine",
    stream: "/feedback/live-stream",
  },

    engagement: {
    dashboard: "/engagement",
    aiengage: "/engagement/aiengage",
    campaigns: "/engagement/campaigns",
    activity_log: "/engagement/activity",
  },

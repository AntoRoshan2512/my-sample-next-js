  ...
  columnHelper.display({
    ...
    cell: ({
      ...
      <div className="flex items-center justify-end gap-3 pe-4">
        <Tooltip content={'Edit Segment'} placement="top" color="invert">
          <Link href={routes.crm.editSegment(row.original.id)}>
        ...
        <DeletePopover
          title={`Delete the segment`}
          description={`Are you sure you want to delete this #${row.original.id} segment?`}

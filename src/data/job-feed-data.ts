...
export const jobFeedData = [
  {
    ...
    jobDescription: [
      {
        descTitle: '',
        desc: 'Sarah Johnson (Lifetime Spend: $12,340) made $550 purchase',
      },
    ],
    skills: ['Send a thank-you + 10% off next visit'],
    rating: 0,
    location: '',
    support: { email: '', desc: '' },
    info: [],
    actions: [
      { label: 'Send Thank You', type: 'primary' },
  ...
  },
  {
    ...
    companyName: '',
    logo: '',
    jobTitle: '12 Customers at High Churn Risk',
    price: '',
    time: '',
    breadcrumb: [],
    jobDescription: [
      {
        descTitle: '',
        desc: 'CLV at risk: $3,450 – low engagement past 30 days',
      },
    ],
    skills: ['Launch a retention campaign (15% off)'],
    rating: 0,
    location: '',
    support: { email: '', desc: '' },
    info: [],
    actions: [
      { label: 'Launch Campaign', type: 'primary' },
      { label: 'View Customers', type: 'secondary' },
    ],
  },
  {
    type: 'action',
    companyName: '',
    logo: '',
    jobTitle: 'Stock Alert: Product X Will Run Out in 3 Days',
    price: '',
    time: '',
    breadcrumb: [],
    jobDescription: [
      {
        descTitle: '',
        desc: 'Current stock: 12 units | Avg daily sales: 4 units',
      },
    ],
    skills: ['Reorder 50 units to meet demand'],
    rating: 0,
    location: '',
    support: { email: '', desc: '' },
    info: [],
